        ...
        <section style={sectionStyles}>
          <div style={contentStyles}>
            ...
            <p>Jun Feng is an Associate Professor in the School of Cyber Science and Engineering at Huazhong University of Science and Technology. 
               ...
               I have published more than 40 papers in top journals (e.g., IEEE Transactions on Dependable and Secure Computing, IEEE Transactions on Computers, 
            ...
            <p align="left"><i><strong><span style="color:#ff0000">冯君老师现招募对大模型安全、机器学习、隐私保护、人工智能安全、深度学习、应用密码学、张量等感兴趣的研究生以及本科科研训练学生，欢迎积极进取、热爱科研的学生与我联系。</span></strong></i></p>
